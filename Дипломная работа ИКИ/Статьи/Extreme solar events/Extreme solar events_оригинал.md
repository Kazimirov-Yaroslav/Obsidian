...
**Authors:** Edward W. Cliver, Carolus J. Schrijver, Kazunari Shibata, Ilya G. Usoskin  
**Journal:** Living Reviews in Solar Physics (2022)  
...
- [[#1.1 1859: in the beginning|1.1 1859: in the beginning]]
- [[#1.2 2003–2004: surge in interest in extreme events|1.2 2003–2004: surge in interest in extreme events]]
- [[#1.3 2012: new windows|1.3 2012: new windows]]
- [[#1.4 Subsequent developments|1.4 Subsequent developments]]
- [[#1.5 Related work|1.5 Related work]]

### [[#2 Sunspot groups|2 Sunspot groups]]
- [[#2.1 100- and 1000-year spot groups|2.1 100- and 1000-year spot groups]]
- [[#2.2 Sunspot groups versus active regions|2.2 Sunspot groups versus active regions]]

### [[#3 Flares on the sun and sun-like stars|3 Flares on the sun and sun-like stars]]
#### [[#3.1 Solar flares|3.1 Solar flares]]
- [[#3.1.1 Solar flare soft X-ray burst classification|3.1.1 Solar flare soft X-ray burst classification]]
- [[#3.1.2 Solar flare frequency distributions|3.1.2 Solar flare frequency distributions]]
- [[#3.1.3 White-light flares|3.1.3 White-light flares]]
- [[#3.1.4 Impulsive and gradual phases of flares: The Neupert effect|3.1.4 Impulsive and gradual phases of flares: The Neupert effect]]
- [[#3.1.5 Energetics of flares and CMEs|3.1.5 Energetics of flares and CMEs]]
- [[#3.1.6 Empirical relationship between flare total solar irradiance and SXR class|3.1.6 Empirical relationship between flare total solar irradiance and SXR class]]
- [[#3.1.7 Estimates of the largest possible solar flare based on the largest observed sunspot group|3.1.7 Estimates of the largest possible solar flare based on the largest observed sunspot group]]

#### [[#3.2 Flares on Sun-like stars|3.2 Flares on Sun-like stars]]
- [[#3.2.1 Stellar flare research before Kepler|3.2.1 Stellar flare research before Kepler]]
- [[#3.2.2 Discovery of superflares on solar-type (vs. Sun-like) stars|3.2.2 Discovery of superflares on solar-type (vs. Sun-like) stars]]
- [[#3.2.3 Verifying the Sun-like nature of superflare stars|3.2.3 Verifying the Sun-like nature of superflare stars]]
- [[#3.2.4 Inferring superflare star properties from brightness variations|3.2.4 Inferring superflare star properties from brightness variations]]
- [[#3.2.5 Occurrence frequency of superflares on Sun-like stars|3.2.5 Occurrence frequency of superflares on Sun-like stars]]

### [[#4 Extreme solar radio bursts|4 Extreme solar radio bursts]]
- [[#4.1 Climatology of solar radio bursts|4.1 Climatology of solar radio bursts]]
- [[#4.2 Observations of extreme decimetric radio bursts|4.2 Observations of extreme decimetric radio bursts]]
- [[#4.3 Are out-sized decimetric spike bursts due to electron cyclotron maser emission?|4.3 Are out-sized decimetric spike bursts due to electron cyclotron maser emission?]]

### [[#5 Coronal mass ejections (CMEs)|5 Coronal mass ejections (CMEs)]]
- [[#5.1 CME climatology|5.1 CME climatology]]
- [[#5.2 Fast transit interplanetary coronal mass ejections (ICMEs)|5.2 Fast transit interplanetary coronal mass ejections (ICMEs)]]

### [[#6 Geomagnetic storms and aurorae|6 Geomagnetic storms and aurorae]]
- [[#6.1 Climatology of extreme geomagnetic storms|6.1 Climatology of extreme geomagnetic storms]]
- [[#6.2 Identified geomagnetic storms (1500-present) with Dst < -500 nT|6.2 Identified geomagnetic storms (1500-present) with Dst < -500 nT]]
- [[#6.3 Timing relationship between great storms and aurora: global substorms|6.3 Timing relationship between great storms and aurora: global substorms]]

### [[#7 Extreme solar energetic proton (SEP) events|7 Extreme solar energetic proton (SEP) events]]
- [[#7.1 Acceleration of protons at the Sun|7.1 Acceleration of protons at the Sun]]
- [[#7.2 Occurrence frequency distribution for directly observed >30 MeV SEP events|7.2 Occurrence frequency distribution for directly observed >30 MeV SEP events]]
- [[#7.3 SEP event proxies|7.3 SEP event proxies]]
  - [[#7.3.1 Nitrate concentration in polar ice (a discredited proxy)|7.3.1 Nitrate concentration in polar ice (a discredited proxy)]]
  - [[#7.3.2 Cosmogenic radionuclides in tree rings and ice cores|7.3.2 Cosmogenic radionuclides in tree rings and ice cores]]
- [[#7.4 SEP events deduced from cosmogenic radionuclide records|7.4 SEP events deduced from cosmogenic radionuclide records]]
  - [[#7.4.1 The greatest known SEP event: 774 AD|7.4.1 The greatest known SEP event: 774 AD]]
  - [[#7.4.2 Energy spectra of cosmogenic-based SEP events|7.4.2 Energy spectra of cosmogenic-based SEP events]]
- [[#7.5 Constraining the F30 OFD with lunar data|7.5 Constraining the F30 OFD with lunar data]]
- [[#7.6 A composite >30 MeV cumulative occurrence frequency distribution|7.6 A composite >30 MeV cumulative occurrence frequency distribution]]
- [[#7.7 Effective energy of different detectors: OFD for F200|7.7 Effective energy of different detectors: OFD for F200]]
- [[#7.8 Does the 774 AD SEP event imply an ~X3000 flare?|7.8 Does the 774 AD SEP event imply an ~X3000 flare?]]

### [[#8 Conclusion|8 Conclusion]]
- [[#8.1 Summary|8.1 Summary]]
- [[#8.2 On the reliability of the 100- and 1000-year event estimates in Table 10|8.2 On the reliability of the 100- and 1000-year event estimates in Table 10]]
  - [[#8.2.1 An important note on GOES SXR event recalibration|8.2.1 An important note on GOES SXR event recalibration]]
- [[#8.3 Discussion|8.3 Discussion]]
  - [[#8.3.1 Is the Sun a Sun-like star?|8.3.1 Is the Sun a Sun-like star?]]
  - [[#8.3.2 Black swans and dragon-kings|8.3.2 Black swans and dragon-kings]]
...
**Figure 2:** Recent growth (through 2020) in citations to Carrington's (1859) Monthly Notices paper on the discovery of the 1859 flare

#### 1.3 2012: new windows

The year 2012 witnessed significant advances, based on disparate data sets, in the study of extreme solar activity. Miyake et al. (2012) obtained high-time-resolution measurements of the 14C concentration in the tree rings of two Japanese cedar trees that showed a transient increase of ~12% from 774 to 775 AD (Fig. 3). The origin of the 774–775 AD 14C enhancement was immediately a matter of debate. Was it caused by a very large solar energetic proton (SEP) event (or a closely-spaced cluster of high-energy proton events such as occurred from August to October 1989) (Usoskin et al. 2013) or by a galactic gamma-ray burst (GRB; Hambaryan and Neuhauser 2013; Pavlov et al. 2013a, b)? Since 2012, numerous studies, including a multi-isotope investigation (Mekhaldi et al. 2015) of the 774–775 AD cosmogenic-nuclide event and a similar event in 993–994 AD discovered by Miyake et al. (2013), have provided strong evidence for the solar scenario (Miyake et al. 2020a).

Potential evidence far from the Sun bearing on the limits of the strength of solar flares was provided by the precise, long-term, and continuous photometry of stars by the Kepler satellite (Koch et al. 2010) that had the search for extra-solar planets as its primary task. For the first 120 days of the Kepler mission, Maehara et al. (2012) reported the observations of 14 superflares (with energy >10^34 erg) on 14,000 Sun-like stars slowly-rotating G-type main-sequence stars with surface temperatures of 5600–6000 K). They calculated that a flare with bolometric energy >10^34 erg could occur on a Sun-like star once every 800 years. The question of whether the Sun in its present state is capable of producing a flare of this size remains unsettled (Aulanier et al. 2013; Shibata et al. 2013; Tschernitz et al. 2018; Schmieder 2018; Notsu et al. 2019; Okamoto et al. 2021). In a detailed survey of 38 large eruptive (i.e., CME-associated) solar flares from 2002 to 2006, Emslie et al. (2012) found that the X28 soft X-ray flare on 4 November 2003 had the largest radiative energy (4.3 × 10^32 erg), while the X17 flare on 28 October 2003 had the largest total (radiative plus CME kinetic energy) energy (1.6 × 10^33 erg). The corresponding inferred values for the Carrington flare are essentially identical to these estimates: ~5 × 10^32 erg (bolometric) and ~2 × 10^33 erg (total) (Cliver and Dietrich 2013).
...
Our focus will be on the largest directly observed, inferred, and theoretically derived values of size/intensity measures of the various types of solar emissions and of geomagnetic storms. For solar flares, geomagnetic storms, and solar proton events, long-term indirect observations are provided by magnetograms (via magnetic crochets), auroral records, and cosmogenic nuclide data, respectively.

We compile lists of the largest observed events in each category for comparison with future events and tabulate estimates of 100- and 1000-year events based on occurrence probability distribution functions.

In Sects. 2–7 we consider the different types of extreme activity, in turn, and in Sect. 8 we present and discuss a summary table of extreme events.

#### 2.1 100- and 1000-year spot groups 

The primary data base used to estimate the areas of 100-year and 1000-year solar spot groups is that compiled at the Royal Greenwich Observatory from 1874 to 1976 (RGO; Willis et al. 2013a, b; Erwin et al. 2013) and extended to the present using data from the US Air Force's Solar Observing Optical Network (SOON) and other observatories (Muñoz-Jaramillo et al. 2015; Giersch et al. 2018; Mandal et al. 2020).[^2] Such estimates begin with histograms of projection-corrected spot group areas (measured in millionths of a solar hemisphere (μsh; 1 μsh = 3.0 × 10^6 km^2)).

Various functional forms have been used to fit the size distribution of spot groups, dependent in part on the data sets and time intervals considered.
...
**Figure 4:** a Size distribution of maximum (circles) and instantaneous (crosses) sunspot group umbral areas. b Same as a for total group areas. The log-normal fits are over-plotted. The vertical lines indicate the smallest areas considered for the fits. Image reproduced with permission from Baumann and Solanki (2005), copyright by ESO
...
**Figure 5:** Distribution of the instantaneous total group sunspot area from RGO, fitted by four different functions. The dark-gray shaded area indicates the range over which the fits were made. Image reproduced with permission from Muñoz-Jaramillo et al. (2015), copyright by AAS
...
#### 3.1 Solar flares {#31-solar-flares}

*Текст подраздела будет добавлен при переводе*

##### 3.1.1 Solar flare soft X-ray burst classification {#311-solar-flare-soft-x-ray-burst-classification}

*Текст подраздела будет добавлен при переводе*

##### 3.1.2 Solar flare frequency distributions {#312-solar-flare-frequency-distributions}

*Текст подраздела будет добавлен при переводе*

##### 3.1.3 White-light flares {#313-white-light-flares}

*Текст подраздела будет добавлен при переводе*

##### 3.1.4 Impulsive and gradual phases of flares: The Neupert effect {#314-impulsive-and-gradual-phases-of-flares-the-neupert-effect}

*Текст подраздела будет добавлен при переводе*

##### 3.1.5 Energetics of flares and CMEs {#315-energetics-of-flares-and-cmes}

*Текст подраздела будет добавлен при переводе*

##### 3.1.6 Empirical relationship between flare total solar irradiance and SXR class {#316-empirical-relationship-between-flare-total-solar-irradiance-and-sxr-class}

*Текст подраздела будет добавлен при переводе*

##### 3.1.7 Estimates of the largest possible solar flare based on the largest observed sunspot group {#317-estimates-of-the-largest-possible-solar-flare-based-on-the-largest-observed-sunspot-group}

*Текст подраздела будет добавлен при переводе*

#### 3.2 Flares on Sun-like stars {#32-flares-on-sun-like-stars}

*Текст подраздела будет добавлен при переводе*

##### 3.2.1 Stellar flare research before Kepler {#321-stellar-flare-research-before-kepler}

*Текст подраздела будет добавлен при переводе*

##### 3.2.2 Discovery of superflares on solar-type (vs. Sun-like) stars {#322-discovery-of-superflares-on-solar-type-vs-sun-like-stars}

*Текст подраздела будет добавлен при переводе*

##### 3.2.3 Verifying the Sun-like nature of superflare stars {#323-verifying-the-sun-like-nature-of-superflare-stars}

*Текст подраздела будет добавлен при переводе*

##### 3.2.4 Inferring superflare star properties from brightness variations {#324-inferring-superflare-star-properties-from-brightness-variations}

*Текст подраздела будет добавлен при переводе*

##### 3.2.5 Occurrence frequency of superflares on Sun-like stars {#325-occurrence-frequency-of-superflares-on-sun-like-stars}
...
#### 4.1 Climatology of solar radio bursts {#41-climatology-of-solar-radio-bursts}

*Текст подраздела будет добавлен при переводе*

#### 4.2 Observations of extreme decimetric radio bursts {#42-observations-of-extreme-decimetric-radio-bursts}

*Текст подраздела будет добавлен при переводе*

#### 4.3 Are out-sized decimetric spike bursts due to electron cyclotron maser emission? {#43-are-out-sized-decimetric-spike-bursts-due-to-electron-cyclotron-maser-emission}
...
#### 5.1 CME climatology {#51-cme-climatology}

*Текст подраздела будет добавлен при переводе*

#### 5.2 Fast transit interplanetary coronal mass ejections (ICMEs) {#52-fast-transit-interplanetary-coronal-mass-ejections-icmes}
...
#### 6.1 Climatology of extreme geomagnetic storms {#61-climatology-of-extreme-geomagnetic-storms}

*Текст подраздела будет добавлен при переводе*

#### 6.2 Identified geomagnetic storms (1500-present) with Dst < -500 nT {#62-identified-geomagnetic-storms-1500-present-with-dst--500-nt}

*Текст подраздела будет добавлен при переводе*

#### 6.3 Timing relationship between great storms and aurora: global substorms {#63-timing-relationship-between-great-storms-and-aurora-global-substorms}
...
#### 7.1 Acceleration of protons at the Sun {#71-acceleration-of-protons-at-the-sun}

*Текст подраздела будет добавлен при переводе*

#### 7.2 Occurrence frequency distribution for directly observed >30 MeV SEP events {#72-occurrence-frequency-distribution-for-directly-observed-30-mev-sep-events}

*Текст подраздела будет добавлен при переводе*

#### 7.3 SEP event proxies {#73-sep-event-proxies}

*Текст подраздела будет добавлен при переводе*

##### 7.3.1 Nitrate concentration in polar ice (a discredited proxy) {#731-nitrate-concentration-in-polar-ice-a-discredited-proxy}

*Текст подраздела будет добавлен при переводе*

##### 7.3.2 Cosmogenic radionuclides in tree rings and ice cores {#732-cosmogenic-radionuclides-in-tree-rings-and-ice-cores}

*Текст подраздела будет добавлен при переводе*

#### 7.4 SEP events deduced from cosmogenic radionuclide records {#74-sep-events-deduced-from-cosmogenic-radionuclide-records}

*Текст подраздела будет добавлен при переводе*

##### 7.4.1 The greatest known SEP event: 774 AD {#741-the-greatest-known-sep-event-774-ad}

*Текст подраздела будет добавлен при переводе*

##### 7.4.2 Energy spectra of cosmogenic-based SEP events {#742-energy-spectra-of-cosmogenic-based-sep-events}

*Текст подраздела будет добавлен при переводе*

#### 7.5 Constraining the F30 OFD with lunar data {#75-constraining-the-f30-ofd-with-lunar-data}

*Текст подраздела будет добавлен при переводе*

#### 7.6 A composite >30 MeV cumulative occurrence frequency distribution {#76-a-composite-30-mev-cumulative-occurrence-frequency-distribution}

*Текст подраздела будет добавлен при переводе*

#### 7.7 Effective energy of different detectors: OFD for F200 {#77-effective-energy-of-different-detectors-ofd-for-f200}

*Текст подраздела будет добавлен при переводе*

#### 7.8 Does the 774 AD SEP event imply an ~X3000 flare? {#78-does-the-774-ad-sep-event-imply-an-x3000-flare}
...
#### 8.2 On the reliability of the 100- and 1000-year event estimates in Table 10 {#82-on-the-reliability-of-the-100-and-1000-year-event-estimates-in-table-10}

*Текст подраздела будет добавлен при переводе*

##### 8.2.1 An important note on GOES SXR event recalibration {#821-an-important-note-on-goes-sxr-event-recalibration}
...
##### 8.3.1 Is the Sun a Sun-like star? {#831-is-the-sun-a-sun-like-star}

*Текст подраздела будет добавлен при переводе*

##### 8.3.2 Black swans and dragon-kings {#832-black-swans-and-dragon-kings}
